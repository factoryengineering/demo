# Festify Application - Comprehensive Overview

## 1. Problem Domain

**Festify** is an **event ticketing and show promotion management system** designed to solve the real-world problem of coordinating live entertainment events across multiple venues. 
...
**[`Venue`](Festify.Domain/Entities/Venue.cs:5)**
...
**[`Act`](Festify.Domain/Entities/Act.cs:3)**
...
**[`Show`](Festify.Domain/Entities/Show.cs:3)**
...
**[`TicketSale`](Festify.Domain/Entities/TicketSale.cs:5)**
...
graph TB
    subgraph "API Layer"
        API[Festify.API<br/>REST Controllers]
    end
    ...
    subgraph "Infrastructure Layer"
        SQL[SqlFestifyContext<br/>SQL Server]
...
Implemented in [`PromotionService`](Festify.Domain/Services/PromotionService.cs:8)

- **Book Shows** ([`BookShow()`](Festify.Domain/Services/PromotionService.cs:17))
...
- **Create Venues** ([`CreateVenue()`](Festify.Domain/Services/PromotionService.cs:43))
...
- **Create Acts** ([`CreateAct()`](Festify.Domain/Services/PromotionService.cs:60))
  - Register performers/entertainment acts
  - Maintain catalog of available performers

- **Reschedule Shows** ([`RescheduleShow()`](Festify.Domain/Services/PromotionService.cs:119))
...
Implemented in [`PromotionService.FindShowsByDistanceAndDateRange()`](Festify.Domain/Services/PromotionService.cs:74)
...
Implemented in [`SalesService`](Festify.Domain/Services/SalesService.cs:7)

- **Sell Tickets** ([`SellTickets()`](Festify.Domain/Services/SalesService.cs:16))
...
Implemented in [`FeedService`](Festify.Domain/Services/FeedService.cs:7)

- **List All Shows** ([`ListShows()`](Festify.Domain/Services/FeedService.cs:16))
...
**Core Value Proposition**: Festify provides an integrated platform for managing the entire live entertainment event lifecycle, from booking to ticket sales, with sophisticated location-based discovery capabilities that connect customers with nearby entertainment options.